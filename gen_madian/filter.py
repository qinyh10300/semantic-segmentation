...
# 示例使用
input_image_path = "gen_madian/output_with_multiple_patches_smoothed.bmp"  # 替换为输入图片路径
output_image_path = "gen_madian/smoothed_filled_with_morphology.bmp"  # 替换为输出图片路径
gray_threshold = 10  # 设置灰度阈值
