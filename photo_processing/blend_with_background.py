...
# 示例使用
filtered_image_path = "photo_processing/smoothed_filled.bmp"  # 替换为过滤后的图片路径
background_image_path = "photo_processing/Background.bmp"  # 替换为背景图片路径
output_image_path = "photo_processing/blended_image.bmp"  # 替换为拼接后的图片保存路径
