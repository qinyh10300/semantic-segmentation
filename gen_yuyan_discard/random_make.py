...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default="/home/qinyh/Downloads/yuyan_output", help='输出目录')
    parser.add_argument('--output_target_dir', type=str, default="/home/qinyh/Downloads/yuyan_target", help='输出目标目录')
