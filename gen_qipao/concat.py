...
def main():
    ...
    parser.add_argument('-s1', '--source1', default="/media/qinyh/KINGSTON/GenData/qipao/qipao_light", help='第一个源文件夹路径')
    parser.add_argument('-s2', '--source2', default="/media/qinyh/KINGSTON/GenData/qipao/qipao_target", help='第二个源文件夹路径')
    parser.add_argument('-d', '--destination', default="/media/qinyh/KINGSTON/GenData/qipao/qipao_add", help='目标文件夹路径')
