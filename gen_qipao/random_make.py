...
def main():
    ...
    parser.add_argument('--img_folder', type=str, default="gen_qipao/qipao_final_matched", help='气泡图像文件夹路径')
    parser.add_argument('--output_dir', type=str, default="gen_qipao/output/output", help='输出目录')
    parser.add_argument('--output_target_dir', type=str, default="gen_qipao/output/output_target", help='输出目标目录')
