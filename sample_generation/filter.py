...
def main():
    ...
    parser.add_argument('--input_folder', type=str, default="sample_generation/output", help='输入图像文件夹路径')
    parser.add_argument('--output_folder', type=str, default="sample_generation/output_filter", help='输出图像文件夹路径')
    parser.add_argument('--lower_threshold', type=int, default=85, help='灰度下限阈值')
