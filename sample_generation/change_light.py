...
def main():
    ...
    parser.add_argument('--input_folder', type=str, default="sample_generation/output_blend", help='输入图像文件夹路径')
    parser.add_argument('--output_folder', type=str, default="sample_generation/output_light", help='输出图像文件夹路径')
