...
def main():
    ...
    parser.add_argument('--input', type=str, default="sample_generation_yuyan/back_meta.png", help='输入图像文件路径')
    parser.add_argument('--output', type=str, default="sample_generation_yuyan/back_larger.png", help='输出图像文件路径')
